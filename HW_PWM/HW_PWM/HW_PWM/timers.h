...
extern volatile uint8_t Gu8_dutyCycle;
extern volatile uint8_t flag;

extern volatile uint8_t mission_complete;
...
#define over_flow_time 125
typedef enum En_timer0PWMFreq_t{
	T0_FERQ_50=50,T0_FERQ_100=100,T0_FERQ_200=200,T0_FERQ_1K=1000,T0_FERQ_2K=2000,T0_FERQ_5K=5000,T0_FERQ_10K=10000
}En_timer0PWMFreq_t;
...
typedef enum En_timer0Mode_t{
	T0_NORMAL_MODE=0,T0_COMP_MODE=0x08,T0_PhaseCorrect_MODE=0x40
}En_timer0Mode_t;
...
typedef enum En_timer0perscaler_t{
	T0_NO_CLOCK=0x00,T0_PRESCALER_NO=0x01,T0_PRESCALER_8=0x02,T0_PRESCALER_64=0x03,T0_PRESCALER_256=0x04,T0_PRESCALER_1024=0x05
...
typedef enum En_timer1Mode_t{
	T1_NORMAL_MODE=0x0000,T1_COMP_MODE_OCR1A_TOP=0x0008, T1_COMP_MODE_ICR1_TOP = 0x0018, T1_PWM_MODE_PHASE_CORRECT_8BITS= 0x0100, T1_PhaseCorrect_MODE_ICR1_TOP=0x0210
